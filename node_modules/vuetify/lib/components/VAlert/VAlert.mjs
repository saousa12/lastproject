  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return isActive.value && _createVNode(props.tag, {
        ...
        }), slots.text ? slots.text() : props.text, (_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots)]), slots.append && _createVNode("div", {
          "class": "v-alert__append"
        }, [slots.append()]), hasClose && _createVNode("div", {
          "class": "v-alert__close",
          "onClick": onCloseClick
        }, [slots.close ? slots.close() : _createVNode(VIcon, {
