    ...
    return () => {
      ...
      return _createVNode(props.tag, {
        ...
        default: () => [_createVNode(VRatingItem, {
          ...
          }) : (_props$itemLabels3 = props.itemLabels) != null && _props$itemLabels3[i] ? _createVNode("span", null, [props.itemLabels[i]]) : _createVNode("span", null, [_createTextVNode("\xA0")]), _createVNode("div", {
